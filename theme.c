...
void initThemes() {
    themes[0] = (ColorScheme){
        ...
        .y                     = hexToColor("#87D602"),
        .z                     = hexToColor("#298CF5"),
        .x_bright              = hexToColor("#FFDCE2"),
        .y_bright              = hexToColor("#F4FFDC"),
        .z_bright              = hexToColor("#DCEFFF"),
        ...
        .fs_tree_dimmed        = hexToColor("#3E3E3E"),
        .gizmo_outer_circle    = hexToColor("#DCDCDC"),
        .gizmo_outer_circle_bright = hexToColor("#FFFFFF"),
        .show_paren_match      = hexToColor(""),
        .isearch_highlight     = hexToColor(""),
        .prompt                = hexToColor("#C6613F"),
        ...
        .vertico_current       = hexToColor("#282A2C"),
