...
void initThemes() {
    themes[0] = (ColorScheme){
        ...
        .gizmo_sphere          = hexToColor("#C4C7C5"),
        .gizmo_sphere_active   = hexToColor("#C4C7C5AA"),
        ...
        .button                = hexToColor("#383838"),
        .button_pressed        = hexToColor("#404040"),
        .shadow                = hexToColor("#979797"),
